...
from support import rawprofiles_dir, profiles_dir#,validYears#, writeLog, validYears
...
#     fig = py.subplots.make_subplots(rows=2, cols=1, subplot_titles=['Percentage of ProfileIDs with Valid Observations for each Hour','Percentage of Valid Observational Hours for each ProfileID'], print_grid=False)
